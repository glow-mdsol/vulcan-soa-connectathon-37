...
from fhirsdk.hl7_fhir_r6_core.base import \
    CodeableConcept, Coding, ContactDetail, Identifier, Period, Reference, RelatedArtifact, TriggerDefinition, \
    UsageContext
...
class EventDefinition(DomainResource):
    ...
    trigger: PyList[TriggerDefinition] = Field(alias="trigger", serialization_alias="trigger")
