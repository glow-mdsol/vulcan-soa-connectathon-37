...
class Quantity(DataType):
    ...
    comparator: Literal["<", "<=", ">=", ">", "ad"] | None = Field(None, alias="comparator", serialization_alias="comparator")
...
class Attachment(DataType):
    ...
    pages: PositiveInt | None = Field(None, alias="pages", serialization_alias="pages")
...
class MonetaryComponent(DataType):
    ...
    type: Literal["base", "surcharge", "discount", "tax", "informational"] = Field(alias="type", serialization_alias="type")
...
class SampledData(DataType):
    ...
    code_map: str | None = Field(None, alias="codeMap", serialization_alias="codeMap")
    data: str | None = Field(None, alias="data", serialization_alias="data")
    dimensions: PositiveInt = Field(alias="dimensions", serialization_alias="dimensions")
    factor: float | None = Field(None, alias="factor", serialization_alias="factor")
    interval: float | None = Field(None, alias="interval", serialization_alias="interval")
    interval_unit: str = Field(alias="intervalUnit", serialization_alias="intervalUnit")
    lower_limit: float | None = Field(None, alias="lowerLimit", serialization_alias="lowerLimit")
    offsets: str | None = Field(None, alias="offsets", serialization_alias="offsets")
...
class RatioRange(DataType):
    ...
    denominator: Quantity | None = Field(None, alias="denominator", serialization_alias="denominator")
    high_numerator: Quantity | None = Field(None, alias="highNumerator", serialization_alias="highNumerator")
    low_numerator: Quantity | None = Field(None, alias="lowNumerator", serialization_alias="lowNumerator")
...
class RelatedArtifact(DataType):
    ...
    publication_status: Literal["draft", "active", "retired", "unknown"] | None = Field(None, alias="publicationStatus", serialization_alias="publicationStatus")
    resource: str | None = Field(None, alias="resource", serialization_alias="resource")
    resource_reference: Reference | None = Field(None, alias="resourceReference", serialization_alias="resourceReference")
    type: Literal["documentation", "justification", "citation", "predecessor", "successor", "derived-from", "depends-on", "composed-of", "part-of", "amends", "amended-with", "appends", "appended-with", "cites", "cited-by", "comments-on", "comment-in", "contains", "contained-in", "corrects", "correction-in", "replaces", "replaced-with", "retracts", "retracted-by", "signs", "similar-to", "supports", "supported-with", "transforms", "transformed-into", "transformed-with", "documents", "specification-of", "created-with", "cite-as"] = Field(alias="type", serialization_alias="type")
...
class VirtualServiceDetail(DataType):
    ...
    additional_info: PyList[str] | None = Field(None, alias="additionalInfo", serialization_alias="additionalInfo")
    address_contact_point: ContactPoint | None = Field(None, alias="addressContactPoint", serialization_alias="addressContactPoint")
    address_extended_contact_detail: ExtendedContactDetail | None = Field(None, alias="addressExtendedContactDetail", serialization_alias="addressExtendedContactDetail")
    address_string: str | None = Field(None, alias="addressString", serialization_alias="addressString")
    address_url: str | None = Field(None, alias="addressUrl", serialization_alias="addressUrl")
    channel_type: Coding | None = Field(None, alias="channelType", serialization_alias="channelType")
    max_participants: PositiveInt | None = Field(None, alias="maxParticipants", serialization_alias="maxParticipants")
    session_key: str | None = Field(None, alias="sessionKey", serialization_alias="sessionKey")
...
class Availability(DataType):
    model_config = ConfigDict(validate_by_name=True, serialize_by_alias=True, extra="forbid")
    
    available_time: PyList[AvailabilityAvailableTime] | None = Field(None, alias="availableTime", serialization_alias="availableTime")
    not_available_time: PyList[AvailabilityNotAvailableTime] | None = Field(None, alias="notAvailableTime", serialization_alias="notAvailableTime")
    period: Period | None = Field(None, alias="period", serialization_alias="period")
...
class DataRequirementValueFilter(BackboneElement):
    ...
    comparator: Literal["eq", "gt", "lt", "ge", "le", "sa", "eb"] | None = Field(None, alias="comparator", serialization_alias="comparator")
    path: str | None = Field(None, alias="path", serialization_alias="path")
    search_param: str | None = Field(None, alias="searchParam", serialization_alias="searchParam")
    value_date_time: str | None = Field(None, alias="valueDateTime", serialization_alias="valueDateTime")
    value_duration: Duration | None = Field(None, alias="valueDuration", serialization_alias="valueDuration")
...
class DataRequirement(DataType):
    ...
    type: Literal["Base", "Element", "Resource", "BackboneElement", "DataType", "xhtml", "Address", "Annotation", "Attachment", "Availability", "BackboneType", "CodeableConcept", "CodeableReference", "Coding", "ContactDetail", "ContactPoint", "Contributor", "DataRequirement", "Expression", "ExtendedContactDetail", "Extension", "HumanName", "Identifier", "Meta", "MonetaryComponent", "Money", "Narrative", "ParameterDefinition", "Period", "PrimitiveType", "Quantity", "Range", "Ratio", "RatioRange", "Reference", "RelatedArtifact", "SampledData", "Signature", "TriggerDefinition", "UsageContext", "VirtualServiceDetail", "Dosage", "ElementDefinition", "MarketingStatus", "ProductShelfLife", "RelativeTime", "Timing", "base64Binary", "boolean", "date", "dateTime", "decimal", "instant", "integer", "integer64", "string", "time", "uri", "positiveInt", "unsignedInt", "code", "id", "markdown", "canonical", "oid", "url", "uuid", "Age", "Count", "Distance", "Duration", "Binary", "Bundle", "DomainResource", "Parameters", "Account", "ActivityDefinition", "ActorDefinition", "AdministrableProductDefinition", "AdverseEvent", "AllergyIntolerance", "Appointment", "AppointmentResponse", "ArtifactAssessment", "AuditEvent", "Basic", "BiologicallyDerivedProduct", "BiologicallyDerivedProductDispense", "BodyStructure", "CanonicalResource", "CapabilityStatement", "CarePlan", "CareTeam", "ChargeItem", "ChargeItemDefinition", "Citation", "Claim", "ClaimResponse", "ClinicalAssessment", "ClinicalUseDefinition", "CodeSystem", "Communication", "CommunicationRequest", "CompartmentDefinition", "Composition", "ConceptMap", "Condition", "ConditionDefinition", "Consent", "Contract", "Coverage", "CoverageEligibilityRequest", "CoverageEligibilityResponse", "DetectedIssue", "Device", "DeviceAlert", "DeviceAssociation", "DeviceDefinition", "DeviceDispense", "DeviceMetric", "DeviceRequest", "DeviceUsage", "DiagnosticReport", "DocumentReference", "Encounter", "EncounterHistory", "Endpoint", "EnrollmentRequest", "EnrollmentResponse", "EpisodeOfCare", "EventDefinition", "Evidence", "EvidenceVariable", "ExampleScenario", "ExplanationOfBenefit", "FamilyMemberHistory", "Flag", "FormularyItem", "GenomicStudy", "Goal", "GraphDefinition", "Group", "GuidanceResponse", "HealthcareService", "ImagingSelection", "ImagingStudy", "Immunization", "ImmunizationEvaluation", "ImmunizationRecommendation", "ImplementationGuide", "Ingredient", "InsurancePlan", "InsuranceProduct", "InventoryItem", "InventoryReport", "Invoice", "Library", "Linkage", "List", "Location", "ManufacturedItemDefinition", "Measure", "MeasureReport", "Medication", "MedicationAdministration", "MedicationDispense", "MedicationKnowledge", "MedicationRequest", "MedicationStatement", "MedicinalProductDefinition", "MessageDefinition", "MessageHeader", "MetadataResource", "MolecularDefinition", "MolecularSequence", "NamingSystem", "NutritionIntake", "NutritionOrder", "NutritionProduct", "Observation", "ObservationDefinition", "OperationDefinition", "OperationOutcome", "Organization", "OrganizationAffiliation", "PackagedProductDefinition", "Patient", "PaymentNotice", "PaymentReconciliation", "Permission", "Person", "PersonalRelationship", "PlanDefinition", "Practitioner", "PractitionerRole", "Procedure", "Provenance", "Questionnaire", "QuestionnaireResponse", "RegulatedAuthorization", "RelatedPerson", "RequestOrchestration", "Requirements", "ResearchStudy", "ResearchSubject", "RiskAssessment", "Schedule", "SearchParameter", "ServiceRequest", "Slot", "Specimen", "SpecimenDefinition", "StructureDefinition", "StructureMap", "Subscription", "SubscriptionStatus", "SubscriptionTopic", "Substance", "SubstanceDefinition", "SubstanceNucleicAcid", "SubstancePolymer", "SubstanceProtein", "SubstanceReferenceInformation", "SubstanceSourceMaterial", "SupplyDelivery", "SupplyRequest", "Task", "TerminologyCapabilities", "TestPlan", "TestReport", "TestScript", "Transport", "ValueSet", "VerificationResult", "VisionPrescription"] = Field(alias="type", serialization_alias="type")
    value_filter: PyList[DataRequirementValueFilter] | None = Field(None, alias="valueFilter", serialization_alias="valueFilter")
...
class TimingRepeat(BackboneElement):
    ...
    when: PyList[Literal["MORN", "MORN.early", "MORN.late", "NOON", "AFT", "AFT.early", "AFT.late", "EVE", "EVE.early", "EVE.late", "NIGHT", "PHS", "IMD", "HS", "WAKE", "C", "CM", "CD", "CV", "AC", "ACM", "ACD", "ACV", "PC", "PCM", "PCD", "PCV"]] | None = Field(None, alias="when", serialization_alias="when")
...
class TriggerDefinition(DataType):
    ...
    name: str | None = Field(None, alias="name", serialization_alias="name")
    subscription_topic: str | None = Field(None, alias="subscriptionTopic", serialization_alias="subscriptionTopic")
...
class Dosage(BackboneType):
    ...
    max_dose_per_period: PyList[Ratio] | None = Field(None, alias="maxDosePerPeriod", serialization_alias="maxDosePerPeriod")
...
class RelativeTime(BackboneType):
    model_config = ConfigDict(validate_by_name=True, serialize_by_alias=True, extra="forbid")
    
    context_code: CodeableConcept | None = Field(None, alias="contextCode", serialization_alias="contextCode")
    context_definition: str | None = Field(None, alias="contextDefinition", serialization_alias="contextDefinition")
    context_path: str | None = Field(None, alias="contextPath", serialization_alias="contextPath")
    context_reference: Reference | None = Field(None, alias="contextReference", serialization_alias="contextReference")
...
class ProductShelfLife(BackboneType):
    ...
    period_duration: Duration | None = Field(None, alias="periodDuration", serialization_alias="periodDuration")
    period_string: str | None = Field(None, alias="periodString", serialization_alias="periodString")
...
class Extension(DataType):
    ...
    value_availability: Availability | None = Field(None, alias="valueAvailability", serialization_alias="valueAvailability")
    ...
    value_codeable_concept: CodeableConcept | None = Field(None, alias="valueCodeableConcept", serialization_alias="valueCodeableConcept")
    value_codeable_reference: CodeableReference | None = Field(None, alias="valueCodeableReference", serialization_alias="valueCodeableReference")
    ...
    value_extended_contact_detail: ExtendedContactDetail | None = Field(None, alias="valueExtendedContactDetail", serialization_alias="valueExtendedContactDetail")
    ...
    value_ratio_range: RatioRange | None = Field(None, alias="valueRatioRange", serialization_alias="valueRatioRange")
    value_reference: Reference | None = Field(None, alias="valueReference", serialization_alias="valueReference")
...
class ElementDefinitionBinding(BackboneElement):
    ...
    additional: PyList[ElementDefinitionBindingAdditional] | None = Field(None, alias="additional", serialization_alias="additional")
    description: str | None = Field(None, alias="description", serialization_alias="description")
    strength: Literal["required", "extensible", "preferred", "example", "descriptive"] = Field(alias="strength", serialization_alias="strength")
    value_set: str | None = Field(None, alias="valueSet", serialization_alias="valueSet")

class ElementDefinitionBindingAdditional(BackboneElement):
    model_config = ConfigDict(validate_by_name=True, serialize_by_alias=True, extra="forbid")
    
    any: bool | None = Field(None, alias="any", serialization_alias="any")
    documentation: str | None = Field(None, alias="documentation", serialization_alias="documentation")
    key: str | None = Field(None, alias="key", serialization_alias="key")
    purpose: Literal["maximum", "minimum", "required", "extensible", "candidate", "current", "preferred", "ui", "starter", "component"] = Field(alias="purpose", serialization_alias="purpose")
    short_doco: str | None = Field(None, alias="shortDoco", serialization_alias="shortDoco")
    usage: PyList[UsageContext] | None = Field(None, alias="usage", serialization_alias="usage")
...
class ElementDefinitionConstraint(BackboneElement):
    ...
    source: str | None = Field(None, alias="source", serialization_alias="source")
    suppress: bool | None = Field(None, alias="suppress", serialization_alias="suppress")
...
class ElementDefinitionSlicingDiscriminator(BackboneElement):
    ...
    path: str = Field(alias="path", serialization_alias="path")
    type: Literal["value", "exists", "pattern", "type", "profile", "position"] = Field(alias="type", serialization_alias="type")
...
class ElementDefinition(BackboneType):
    ...
    default_value_availability: Availability | None = Field(None, alias="defaultValueAvailability", serialization_alias="defaultValueAvailability")
    ...
    default_value_codeable_reference: CodeableReference | None = Field(None, alias="defaultValueCodeableReference", serialization_alias="defaultValueCodeableReference")
    ...
    default_value_extended_contact_detail: ExtendedContactDetail | None = Field(None, alias="defaultValueExtendedContactDetail", serialization_alias="defaultValueExtendedContactDetail")
    ...
    default_value_integer64: int | None = Field(None, alias="defaultValueInteger64", serialization_alias="defaultValueInteger64")
    ...
    default_value_ratio_range: RatioRange | None = Field(None, alias="defaultValueRatioRange", serialization_alias="defaultValueRatioRange")
    ...
    fixed_availability: Availability | None = Field(None, alias="fixedAvailability", serialization_alias="fixedAvailability")
    ...
    fixed_codeable_reference: CodeableReference | None = Field(None, alias="fixedCodeableReference", serialization_alias="fixedCodeableReference")
    ...
    fixed_extended_contact_detail: ExtendedContactDetail | None = Field(None, alias="fixedExtendedContactDetail", serialization_alias="fixedExtendedContactDetail")
    ...
    fixed_integer64: int | None = Field(None, alias="fixedInteger64", serialization_alias="fixedInteger64")
    ...
    fixed_ratio_range: RatioRange | None = Field(None, alias="fixedRatioRange", serialization_alias="fixedRatioRange")
    ...
    max_value_integer64: int | None = Field(None, alias="maxValueInteger64", serialization_alias="maxValueInteger64")
    ...
    min_value_integer64: int | None = Field(None, alias="minValueInteger64", serialization_alias="minValueInteger64")
    ...
    must_have_value: bool | None = Field(None, alias="mustHaveValue", serialization_alias="mustHaveValue")
    ...
    pattern_availability: Availability | None = Field(None, alias="patternAvailability", serialization_alias="patternAvailability")
    ...
    pattern_codeable_reference: CodeableReference | None = Field(None, alias="patternCodeableReference", serialization_alias="patternCodeableReference")
    ...
    pattern_extended_contact_detail: ExtendedContactDetail | None = Field(None, alias="patternExtendedContactDetail", serialization_alias="patternExtendedContactDetail")
    ...
    pattern_integer64: int | None = Field(None, alias="patternInteger64", serialization_alias="patternInteger64")
    ...
    pattern_ratio_range: RatioRange | None = Field(None, alias="patternRatioRange", serialization_alias="patternRatioRange")
    ...
    value_alternatives: PyList[str] | None = Field(None, alias="valueAlternatives", serialization_alias="valueAlternatives")
