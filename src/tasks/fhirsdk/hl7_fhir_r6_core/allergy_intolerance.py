...
class AllergyIntoleranceReaction(BackboneElement):
    ...
    manifestation: PyList[CodeableReference] = Field(alias="manifestation", serialization_alias="manifestation")
...
class AllergyIntolerance(DomainResource):
    ...
    last_reaction_occurrence: str | None = Field(None, alias="lastReactionOccurrence", serialization_alias="lastReactionOccurrence")
    note: PyList[Annotation] | None = Field(None, alias="note", serialization_alias="note")
