...
class PatientContact(BackboneElement):
    ...
    additional_address: PyList[Address] | None = Field(None, alias="additionalAddress", serialization_alias="additionalAddress")
    additional_name: PyList[HumanName] | None = Field(None, alias="additionalName", serialization_alias="additionalName")
