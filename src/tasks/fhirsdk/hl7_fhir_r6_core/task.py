...
class Task(DomainResource):
    ...
    performer: PyList[TaskPerformer] | None = Field(None, alias="performer", serialization_alias="performer")
    ...
    requested_performer: PyList[CodeableReference] | None = Field(None, alias="requestedPerformer", serialization_alias="requestedPerformer")
    requested_period: Period | None = Field(None, alias="requestedPeriod", serialization_alias="requestedPeriod")
