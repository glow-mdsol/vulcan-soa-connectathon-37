...
from fhirsdk.hl7_fhir_r6_core.base import \
    Address, Age, Annotation, Attachment, Availability, BackboneElement, CodeableConcept, CodeableReference, \
    Coding, ContactDetail, ContactPoint, Count, DataRequirement, Distance, Dosage, Duration, Expression, ExtendedContactDetail, \
    HumanName, Identifier, Meta, Money, ParameterDefinition, Period, Quantity, Range, Ratio, RatioRange, Reference, \
    RelatedArtifact, SampledData, Signature, Timing, TriggerDefinition, UsageContext
...
class Transport(DomainResource):
    ...
    completion_time: str | None = Field(None, alias="completionTime", serialization_alias="completionTime")
    current_location: Reference = Field(alias="currentLocation", serialization_alias="currentLocation")
    ...
    history: Reference | None = Field(None, alias="history", serialization_alias="history")
    identifier: PyList[Identifier] | None = Field(None, alias="identifier", serialization_alias="identifier")
    input: PyList[TransportInput] | None = Field(None, alias="input", serialization_alias="input")
    instantiates: str | None = Field(None, alias="instantiates", serialization_alias="instantiates")
    ...
    output: PyList[TransportOutput] | None = Field(None, alias="output", serialization_alias="output")
    ...
    reason: CodeableReference | None = Field(None, alias="reason", serialization_alias="reason")
    relevant_history: PyList[Reference] | None = Field(None, alias="relevantHistory", serialization_alias="relevantHistory")
    requested_location: Reference = Field(alias="requestedLocation", serialization_alias="requestedLocation")
    requester: Reference | None = Field(None, alias="requester", serialization_alias="requester")
    restriction: TransportRestriction | None = Field(None, alias="restriction", serialization_alias="restriction")
    status: Literal["preparation", "in-progress", "not-done", "suspended", "stopped", "on-hold", "completed", "entered-in-error", "unknown"] | None = Field(None, alias="status", serialization_alias="status")
    ...
    @classmethod
    def from_json(cls, json: str) -> Transport:
