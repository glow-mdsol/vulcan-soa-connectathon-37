...
from fhirsdk.hl7_fhir_r6_core.base import \
    Age, BackboneElement, CodeableConcept, CodeableReference, Coding, ContactDetail, DataRequirement, Duration, \
    Expression, Identifier, Period, Quantity, Range, Ratio, Reference, RelatedArtifact, Timing, TriggerDefinition, \
    UsageContext
...
class PlanDefinitionAction(BackboneElement):
    ...
    action: PyList[PlanDefinitionAction] | None = Field(None, alias="action", serialization_alias="action")
    ...
    condition: PyList[PlanDefinitionActionCondition] | None = Field(None, alias="condition", serialization_alias="condition")
    ...
    dynamic_value: PyList[PlanDefinitionActionDynamicValue] | None = Field(None, alias="dynamicValue", serialization_alias="dynamicValue")
    goal_id: PyList[str] | None = Field(None, alias="goalId", serialization_alias="goalId")
    ...
    input: PyList[PlanDefinitionActionInput] | None = Field(None, alias="input", serialization_alias="input")
    ...
    output: PyList[PlanDefinitionActionOutput] | None = Field(None, alias="output", serialization_alias="output")
    participant: PyList[PlanDefinitionActionParticipant] | None = Field(None, alias="participant", serialization_alias="participant")
    ...
    related_action: PyList[PlanDefinitionActionRelatedAction] | None = Field(None, alias="relatedAction", serialization_alias="relatedAction")
...
class PlanDefinitionActor(BackboneElement):
    ...
    description: str | None = Field(None, alias="description", serialization_alias="description")
    option: PyList[PlanDefinitionActorOption] = Field(alias="option", serialization_alias="option")
    title: str | None = Field(None, alias="title", serialization_alias="title")
...
class PlanDefinition(DomainResource):
    ...
    action: PyList[PlanDefinitionAction] | None = Field(None, alias="action", serialization_alias="action")
    actor: PyList[PlanDefinitionActor] | None = Field(None, alias="actor", serialization_alias="actor")
    ...
    goal: PyList[PlanDefinitionGoal] | None = Field(None, alias="goal", serialization_alias="goal")
