...
from fhirsdk.hl7_fhir_r6_core.base import \
    CodeableConcept, Coding, ContactDetail, Identifier, UsageContext
...
class ActorDefinition(DomainResource):
    ...
    base_definition: PyList[str] | None = Field(None, alias="baseDefinition", serialization_alias="baseDefinition")
    ...
    type: Literal["system", "non-system", "individual", "device", "collective", "patient", "practitioner", "related-person", "care-team", "group", "healthcare-service", "organization"] = Field(alias="type", serialization_alias="type")
    ...
    @classmethod
    def from_json(cls, json: str) -> ActorDefinition:
