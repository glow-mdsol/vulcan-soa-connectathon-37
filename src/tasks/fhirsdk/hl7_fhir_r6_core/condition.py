...
class Condition(DomainResource):
    ...
    clinical_status: CodeableConcept = Field(alias="clinicalStatus", serialization_alias="clinicalStatus")
    code: CodeableConcept | None = Field(None, alias="code", serialization_alias="code")
    encounter: Reference | None = Field(None, alias="encounter", serialization_alias="encounter")
    evidence: PyList[CodeableReference] | None = Field(None, alias="evidence", serialization_alias="evidence")
