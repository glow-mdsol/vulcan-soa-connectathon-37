...
class FamilyMemberHistory(DomainResource):
    ...
    note: PyList[Annotation] | None = Field(None, alias="note", serialization_alias="note")
    participant: PyList[FamilyMemberHistoryParticipant] | None = Field(None, alias="participant", serialization_alias="participant")
    patient: Reference = Field(alias="patient", serialization_alias="patient")
    procedure: PyList[FamilyMemberHistoryProcedure] | None = Field(None, alias="procedure", serialization_alias="procedure")
