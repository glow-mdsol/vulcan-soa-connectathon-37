...
from fhirsdk.hl7_fhir_r6_core.base import CodeableConcept, CodeableReference, Identifier, Reference
...
class Slot(DomainResource):
    ...
    appointment_type: PyList[CodeableConcept] | None = Field(None, alias="appointmentType", serialization_alias="appointmentType")
