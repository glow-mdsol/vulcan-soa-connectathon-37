...
class QuestionnaireItem(BackboneElement):
    ...
    answer_constraint: Literal["optionsOnly", "optionsOrType", "optionsOrString"] | None = Field(None, alias="answerConstraint", serialization_alias="answerConstraint")
    answer_option: PyList[QuestionnaireItemAnswerOption] | None = Field(None, alias="answerOption", serialization_alias="answerOption")
    answer_value_set: str | None = Field(None, alias="answerValueSet", serialization_alias="answerValueSet")
    ...
    disabled_display: Literal["hidden", "protected"] | None = Field(None, alias="disabledDisplay", serialization_alias="disabledDisplay")
    enable_behavior: Literal["all", "any"] | None = Field(None, alias="enableBehavior", serialization_alias="enableBehavior")
    ...
    type: Literal["group", "display", "question", "boolean", "decimal", "integer", "date", "dateTime", "time", "string", "text", "url", "coding", "attachment", "reference", "quantity"] = Field(alias="type", serialization_alias="type")
