...
class SearchParameter(DomainResource):
    ...
    alias_code: PyList[str] | None = Field(None, alias="aliasCode", serialization_alias="aliasCode")
    base: PyList[str] = Field(alias="base", serialization_alias="base")
    ...
    constraint: str | None = Field(None, alias="constraint", serialization_alias="constraint")
    ...
    processing_mode: Literal["normal", "phonetic", "other"] | None = Field(None, alias="processingMode", serialization_alias="processingMode")
    ...
    target: PyList[str] | None = Field(None, alias="target", serialization_alias="target")
