...
class ClaimItem(BackboneElement):
    ...
    body_site: PyList[ClaimItemBodySite] | None = Field(None, alias="bodySite", serialization_alias="bodySite")
...
class Claim(DomainResource):
    ...
    event: PyList[ClaimEvent] | None = Field(None, alias="event", serialization_alias="event")
    ...
    insurance: PyList[ClaimInsurance] | None = Field(None, alias="insurance", serialization_alias="insurance")
