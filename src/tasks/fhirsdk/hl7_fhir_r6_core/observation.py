...
from fhirsdk.hl7_fhir_r6_core.base import \
    Annotation, Attachment, BackboneElement, CodeableConcept, Identifier, Period, Quantity, Range, Ratio, \
    Reference, SampledData, Timing
...
class ObservationReferenceRange(BackboneElement):
    ...
    normal_value: CodeableConcept | None = Field(None, alias="normalValue", serialization_alias="normalValue")
...
class ObservationTriggeredBy(BackboneElement):
    ...
    observation: Reference = Field(alias="observation", serialization_alias="observation")
    reason: str | None = Field(None, alias="reason", serialization_alias="reason")
    type: Literal["reflex", "repeat", "re-run"] = Field(alias="type", serialization_alias="type")
...
class Observation(DomainResource):
    ...
    instantiates_reference: Reference | None = Field(None, alias="instantiatesReference", serialization_alias="instantiatesReference")
    interpretation: PyList[CodeableConcept] | None = Field(None, alias="interpretation", serialization_alias="interpretation")
    ...
    organizer: bool | None = Field(None, alias="organizer", serialization_alias="organizer")
    ...
    triggered_by: PyList[ObservationTriggeredBy] | None = Field(None, alias="triggeredBy", serialization_alias="triggeredBy")
    value_attachment: Attachment | None = Field(None, alias="valueAttachment", serialization_alias="valueAttachment")
    value_boolean: bool | None = Field(None, alias="valueBoolean", serialization_alias="valueBoolean")
    value_codeable_concept: CodeableConcept | None = Field(None, alias="valueCodeableConcept", serialization_alias="valueCodeableConcept")
    value_date_time: str | None = Field(None, alias="valueDateTime", serialization_alias="valueDateTime")
