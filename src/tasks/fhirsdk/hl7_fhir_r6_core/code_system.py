...
class CodeSystemFilter(BackboneElement):
    ...
    operator: PyList[Literal["=", "is-a", "descendent-of", "is-not-a", "regex", "in", "not-in", "generalizes", "child-of", "descendent-leaf", "exists"]] = Field(alias="operator", serialization_alias="operator")
    value: str = Field(alias="value", serialization_alias="value")
