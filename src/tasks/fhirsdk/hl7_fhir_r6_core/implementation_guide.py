...
class ImplementationGuideDefinitionPage(BackboneElement):
    ...
    source_markdown: str | None = Field(None, alias="sourceMarkdown", serialization_alias="sourceMarkdown")
    source_string: str | None = Field(None, alias="sourceString", serialization_alias="sourceString")
    source_url: str | None = Field(None, alias="sourceUrl", serialization_alias="sourceUrl")
...
class ImplementationGuideDefinitionResource(BackboneElement):
    ...
    description: str | None = Field(None, alias="description", serialization_alias="description")
    fhir_version: PyList[Literal["0.01", "0.05", "0.06", "0.11", "0.0", "0.4", "0.5", "1.0", "1.1", "1.4", "1.6", "1.8", "3.0", "3.3", "3.5", "4.0", "4.1", "4.2", "4.3", "4.4", "4.5", "4.6", "5.0", "6.0", "0.0.80", "0.0.81", "0.0.82", "0.4.0", "0.5.0", "1.0.0", "1.0.1", "1.0.2", "1.1.0", "1.4.0", "1.6.0", "1.8.0", "3.0.0", "3.0.1", "3.0.2", "3.3.0", "3.5.0", "4.0.0", "4.0.1", "4.1.0", "4.2.0", "4.3.0", "4.3.0-cibuild", "4.3.0-snapshot1", "4.4.0", "4.5.0", "4.6.0", "5.0.0", "5.0.0-cibuild", "5.0.0-snapshot1", "5.0.0-snapshot2", "5.0.0-ballot", "5.0.0-snapshot3", "5.0.0-draft-final", "6.0.0", "6.0.0-ballo1", "6.0.0-ballot2", "6.0.0-ballot3"]] | None = Field(None, alias="fhirVersion", serialization_alias="fhirVersion")
    grouping_id: str | None = Field(None, alias="groupingId", serialization_alias="groupingId")
    is_example: bool | None = Field(None, alias="isExample", serialization_alias="isExample")
