Instance: SoA-PoC-ResearchStudy-DynamicProtocol-ScenarioTwo-Bundle
InstanceOf: Bundle
Usage: #example
* type = #transaction
* entry[+]
  * resource = SoA-PoC-ResearchStudy-DynamicProtocol-ScenarioTwo
  * request
    * method = #POST  
    * url = "ResearchStudy"  
* entry[+]
  * resource = SoA-PoC-DynamicProtocol-ScenarioTwo-ProtocolDesign
  * request
    * method = #POST  
    * url = "PlanDefinition"  
* entry[+]
