Instance: SoA-PoC-ResearchStudy-DynamicProtocol-ScenarioOne-Bundle
InstanceOf: Bundle
Usage: #example
* type = #transaction
* entry[+]
  * resource = SoA-PoC-ResearchStudy-DynamicProtocol-ScenarioOne
  * request
    * method = #POST  
    * url = "ResearchStudy"  
* entry[+]
  * resource = SoA-PoC-DynamicProtocol-ScenarioOne-ProtocolDesign
  * request
    * method = #POST  
    * url = "PlanDefinition"  
* entry[+]
